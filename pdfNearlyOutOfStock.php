...
$html .= '    <tr><td><img style="height:50px;margin-left: 10px;" src="Logo.jpg" alt="" srcset=""></td><td style="margin-left:30px"><br><h4 >&nbsp;&nbsp;&nbsp;รายงานอุปกรณ์ใกล้หมดประจำวันที่ '.$day." ".$month." ".$year.'</h4></td></tr>';
$html .= '    <tr ><td style="width:1px"></td><td ></td></tr>';
$html .= '</table>';
$html .= "";

$json = file_get_contents('http://localhost/stationarySystem/api/stationary/readNearlyOutOfStock.php');
